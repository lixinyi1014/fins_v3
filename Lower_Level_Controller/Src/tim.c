...
void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = TIM1;
  /* 168 MHz / 1120 / 1000 = 150 Hz; keep the existing timer cadence.
   * 保留当前 150 Hz 主调度，配置集中在 LowerControllerConfig.h。 */
  htim1.Init.Prescaler = LC_TIM1_PRESCALER; // 1120-1，即 1119
  htim1.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim1.Init.Period = LC_TIM1_PERIOD; // 1000-1，即 999
